...
export default function Home() {
  ...
  return <main ref={pageRef}><div className="topbar"><span>TOEIC® SCORE ESTIMATOR</span><span>多益答對題數計算器</span></div><div className="page-shell">
    ...
    <section className="report-header"><div className="candidate-photo"><svg viewBox="0 0 180 220" role="img" aria-label="企鵝示意圖片"><rect width="180" height="220" fill="#d9e7e9"/><ellipse cx="90" cy="207" rx="68" ry="9" fill="#b9cbce"/><ellipse cx="90" cy="123" rx="62" ry="88" fill="#202323"/><ellipse cx="90" cy="140" rx="44" ry="64" fill="#fffdf3"/><ellipse cx="71" cy="78" rx="19" ry="25" fill="#fffdf3"/><ellipse cx="109" cy="78" rx="19" ry="25" fill="#fffdf3"/><circle cx="75" cy="77" r="5"/><circle cx="105" cy="77" r="5"/><path d="M76 96 L104 96 L90 112 Z" fill="#ee8b31"/><ellipse cx="63" cy="207" rx="25" ry="9" fill="#ee8b31"/><ellipse cx="117" cy="207" rx="25" ry="9" fill="#ee8b31"/></svg><small>企鵝示意圖</small></div><div className="candidate-info"><div className="candidate-field"><strong>林宇翔</strong><strong>LIN YU-HSIANG</strong><small>Name · 姓名</small></div><div className="candidate-field"><strong>1998/06/15</strong><small>Date of Birth · 生日</small></div><div className="candidate-pair"><div className="candidate-field"><strong>26091234</strong><small>Registration Number<br/>準考證號碼</small></div><div className="candidate-field"><strong>2026/09/20</strong><small>Test Date · 測驗日期</small></div></div><div className="candidate-field"><strong>09:30–12:00</strong><small>Test Time · 測驗時間</small></div><small className="sample-note">以上為虛構示範資料</small></div><section className="score-card"><div className="score-main"><ScoreRow label="LISTENING" zh="聽力" score={listeningScore} onChange={setListeningScore} tone="orange"/><ScoreRow label="READING" zh="閱讀" score={readingScore} onChange={setReadingScore} tone="orange"/></div><aside className="total-score"><span>TOTAL<br/>SCORE</span><b>{listeningScore + readingScore}</b><em>/ 990</em></aside></section></section>
